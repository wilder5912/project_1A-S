...
@Component({
  selector: 'app-home-cashier-page',
  templateUrl: './home-cashier-page.component.html',
  styleUrls: ['./home-cashier-page.component.css']
})
export class HomeCashierPageComponent implements OnInit {
