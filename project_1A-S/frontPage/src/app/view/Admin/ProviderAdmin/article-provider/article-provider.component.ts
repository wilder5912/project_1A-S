...
@Component({
  selector: 'app-article-provider',
  templateUrl: './article-provider.component.html',
  styleUrls: ['./article-provider.component.css']
})
export class ArticleProviderComponent implements OnInit {
  public form: FormGroup;
  public modalRefArticleProvider: BsModalRef;
  public options;
